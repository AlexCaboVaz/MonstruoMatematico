...
export class ApiClient {
  ...
  obtenerJugador(playerId) {
    return this._request(`/players/${playerId}`);
  }
  ...
  listarTienda(playerId) {
    return this._request(`/players/${playerId}/shop-items`);
  }

  listarComidaPendiente(playerId) {
    return this._request(`/players/${playerId}/pending-food`);
  }

  comprarItem(playerId, itemId) {
    return this._request(`/players/${playerId}/purchases`, {
      method: 'POST',
  ...
  alimentarMonstruo(playerId, inventoryId) {
    return this._request(`/players/${playerId}/feed`, {
      method: 'POST',
